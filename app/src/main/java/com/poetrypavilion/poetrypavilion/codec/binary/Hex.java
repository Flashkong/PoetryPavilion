...
package com.poetrypavilion.poetrypavilion.codec.binary;

import java.nio.ByteBuffer;
import java.nio.charset.Charset;

import com.poetrypavilion.poetrypavilion.codec.BinaryDecoder;
import com.poetrypavilion.poetrypavilion.codec.BinaryEncoder;
import com.poetrypavilion.poetrypavilion.codec.CharEncoding;
import com.poetrypavilion.poetrypavilion.codec.Charsets;
import com.poetrypavilion.poetrypavilion.codec.DecoderException;
import com.poetrypavilion.poetrypavilion.codec.EncoderException;
...
public class Hex implements BinaryEncoder, BinaryDecoder {
     ...
     * @since 1.4
     */
    private static final String DEFAULT_CHARSET_NAME = CharEncoding.UTF_8;
     ...
     * @since 1.11
     */
    private static char[] encodeHex(final ByteBuffer data) {
        return encodeHex(data, true);
    }
     ...
     * @since 1.11
     */
    private static char[] encodeHex(final ByteBuffer data, final boolean toLowerCase) {
        return encodeHex(data, toLowerCase ? DIGITS_LOWER : DIGITS_UPPER);
    }
     ...
     * @since 1.11
     */
    private static String encodeHexString(final ByteBuffer data) {
        return new String(encodeHex(data));
    }
     ...
     * @since 1.7
     */
    private Hex(final Charset charset) {
